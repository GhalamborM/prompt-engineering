...
انتخاب بین top-K، top-P، temperature و تعداد token‌هایی که باید تولید شوند، به کاربرد خاص و نتیجه مورد نظر بستگی دارد، و تمام تنظیمات بر یکدیگر تأثیر می‌گذارند. همچنین مهم است که اطمینان حاصل کنید که درک می‌کنید مدل انتخابی شما چگونه تنظیمات نمونه‌گیری مختلف را با هم ترکیب می‌کند.

اگر temperature، top-K و top-P همگی در دسترس باشند (مانند Vertex Studio)، token‌هایی که هم معیارهای top-K و هم top-P را برآورده می‌کنند، نامزدهایی برای token پیش‌بینی شده بعدی هستند، و سپس...
...
نام: 1_1_movie_classification
هدف: طبقه‌بندی نقدهای فیلم به عنوان مثبت، خنثی یا منفی.
مدل: gemini-pro
Temperature: 0.1 محدودیت Token: 5
Top-K: N/A Top-P: 1
Prompt: نقدهای فیلم را به عنوان POSITIVE، NEUTRAL یا NEGATIVE طبقه‌بندی کنید.
نقد: "Her" یک مطالعه ناراحت‌کننده است که مسیری را نشان می‌دهد که بشریت در صورت اجازه دادن به تکامل AI بدون نظارت، به آن سمت حرکت می‌کند. ای کاش فیلم‌های بیشتری مانند این شاهکار وجود داشت.
احساس:
خروجی: POSITIVE
جدول 1. مثالی از prompt دادن از نوع Zero-Shot
...
هدف: نوشتن یک خط داستانی برای یک مرحله از یک بازی ویدیویی تیراندازی اول شخص.
مدل: gemini-pro
Temperature: 1 محدودیت Token: 1024
Top-K: 40 Top-P: 0.8
Prompt: یک پاراگراف خط داستانی برای یک مرحله جدید از یک بازی ویدیویی تیراندازی اول شخص بنویسید که چالش‌برانگیز و جذاب باشد.
خروجی: مرحله با کمین گرفتن دسته بازیکن در یک منطقه شهری متراکم توسط یک گروه دشمن بی‌رحم آغاز می‌شود. بازیکنان باید از میان هزارتویی از کوچه‌های پشتی و ساختمان‌های فرسوده راه خود را با جنگ باز کنند، با استفاده از مخفی‌کاری و دقت برای از بین بردن نیروهای دشمن و جلوگیری از شناسایی شدن. بازیکن باید از محیط خود به نفع خود استفاده کند، تله‌ها را تنظیم کند، از پوشش استفاده کند و حرکات حساب شده‌ای انجام دهد تا زنده بماند. در طول مسیر، آن‌ها اطلاعاتی را کشف می‌کنند که نشان می‌دهد دشمن در حال برنامه‌ریزی یک حمله ویرانگر است، و بازیکن باید با زمان مسابقه دهد تا شواهد را جمع‌آوری کند و آن را به مقر خود برساند قبل از اینکه دشمن بتواند نقشه‌های خود را اجرا کند.
...
Prompt: بر اساس بازی‌های اکشن تیراندازی اول شخص محبوب، 5 تنظیمات کلیدی داستانی که به یک خط داستانی چالش‌برانگیز و جذاب در یک بازی ویدیویی تیراندازی اول شخص کمک می‌کنند، کدامند؟
خروجی:
1. **پایگاه نظامی متروکه**: یک مجتمع نظامی پسا-آخرالزمانی گسترده که پر از سربازان جهش‌یافته و ربات‌های سرکش است، ایده‌آل برای مبارزه چالش‌برانگیز با سلاح گرم.
2. **شهر سایبرپانک**: یک محیط شهری آینده‌نگرانه با نورهای نئون، با آسمان‌خراش‌های بلند و کوچه‌های متراکم، با دشمنان سایبرنتیکی پیشرفته و مکانیک‌های هک کردن.
3. **سفینه فضایی بیگانه**: یک کشتی بیگانه عظیم گیر افتاده روی زمین، با راهروهای عجیب و غریب، بخش‌های بدون جاذبه و موجودات فرازمینی برای مواجهه.
