...
دما نزدیک به حداکثر تمایل به ایجاد خروجی تصادفی‌تر دارند. و هرچه temperature بالاتر و بالاتر می‌رود، همه token‌ها به یک اندازه احتمال دارند که token پیش‌بینی شده بعدی باشند.
...
بحث بعدی، Top-K و top-P (که به عنوان nucleus sampling نیز شناخته می‌شود) دو تنظیم سمپلینگ هستند که در LLM‌ها استفاده می‌شوند تا token بعدی پیش‌بینی شده را به token‌هایی با بالاترین احتمالات پیش‌بینی شده محدود کنند. مانند temperature، این تنظیمات سمپلینگ، تصادفی بودن و تنوع متن تولید شده را کنترل می‌کنند.
