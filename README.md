...
خودسازگاری یک تکنیک پیشرفته است که در آن چندین زنجیره تفکر مختلف تولید می‌شود و سپس پاسخی که بیشترین تکرار را دارد انتخاب می‌شود. این می‌تواند به بهبود دقت، به ویژه برای مسائل استدلالی پیچیده کمک کند.

**مثال خودسازگاری:**

```
مسئله: اگر ۵ کتاب داشته باشم و ۲ کتاب به دوستم قر
